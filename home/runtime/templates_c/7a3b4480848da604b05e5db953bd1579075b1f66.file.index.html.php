<?php /* Smarty version Smarty-3.1.14, created on 2013-08-23 11:30:43
         compiled from "F:\Apmserv\APMServ5\apm\APMServ5.2.6\www\htdocs\home\view\index\index.html" */ ?>
<?php /*%%SmartyHeaderCode:32318520c5a03e59b92-94714288%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '7a3b4480848da604b05e5db953bd1579075b1f66' => 
    array (
      0 => 'F:\\Apmserv\\APMServ5\\apm\\APMServ5.2.6\\www\\htdocs\\home\\view\\index\\index.html',
      1 => 1377257437,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '32318520c5a03e59b92-94714288',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.14',
  'unifunc' => 'content_520c5a03f3b3c9_03466728',
  'variables' => 
  array (
    't_dir' => 0,
    'login' => 0,
...
<?php if ($_valid && !is_callable('content_520c5a03f3b3c9_03466728')) {function content_520c5a03f3b3c9_03466728($_smarty_tpl) {?><!DOCTYPE html>
<html><head>
...
.dy_locbox_w i.close{position: absolute;top:10px;right: 10px;width: 11px;height: 11px;background: url(<?php echo $_smarty_tpl->tpl_vars['t_dir']->value;?>
index/images/icon_3.png) no-repeat -240px -134px;cursor: pointer;}
...
.dy_locbox ul li.loading{width: 416px;margin-top:94px;text-align:center;padding:20px 0 0 0;background: url(<?php echo $_smarty_tpl->tpl_vars['t_dir']->value;?>
index/images/loadgray.gif) no-repeat top;}
...
.dy_locbox ul li.cur .inner i{width: 17px;height: 17px;display:block;position:absolute;bottom:2px; right:2px;background: url(<?php echo $_smarty_tpl->tpl_vars['t_dir']->value;?>
index/images/cked.png) no-repeat}
...
.dy_locbox .locboxft .btn,.dy_locbox .locboxft .btn:hover{background-image:url(<?php echo $_smarty_tpl->tpl_vars['t_dir']->value;?>
index/images/ico_pic2.gif);}
...
index/images/logo.png) no-repeat left}
...
.wrapTab ul{float:left;height:44px;display:inline-block;border:1px solid #d5d5d5;border-bottom: none;background: url(<?php echo $_smarty_tpl->tpl_vars['t_dir']->value;?>
index/images/tabbg1.png) repeat-x bottom;}
...
.wrapTab ul li.cur{height:45px;margin-top:-1px;color:#fff;background: url(<?php echo $_smarty_tpl->tpl_vars['t_dir']->value;?>
index/images/tabbg2.png) repeat-x bottom;z-index: 99}
.wrapTab ul li.cur a{color: #fff}
/*小nav*/
.subTab{height:35px;margin:0px auto 0;border-bottom: 1px solid #d5d5d5;overflow: hidden;*zoom:1; }
.subTab ul{float:left;height:34px;display:inline-block;border:1px solid #d5d5d5;border-bottom: none;background: url(<?php echo $_smarty_tpl->tpl_vars['t_dir']->value;?>
index/images/tabbg1.png) repeat-x bottom;}
...
.subTab ul li.cur{height:35px;margin-top:-1px;color:#fff;background: url(<?php echo $_smarty_tpl->tpl_vars['t_dir']->value;?>
index/images/tabbg2.png) repeat-x bottom;z-index: 99}
...
.rec-user .loading{width: 30px;height: 20px;line-height: 18px;padding: 2px 0 0 25px;overflow: hidden;display: inline-block;background:url(<?php echo $_smarty_tpl->tpl_vars['t_dir']->value;?>
index/images/loading_s.gif);cursor: default;}
...
.menulist .hd{height:44px;background:url(<?php echo $_smarty_tpl->tpl_vars['t_dir']->value;?>
index/images/menulibg.gif);overflow: hidden;*zoom:1;}
...
.menulist .bd li a{width: 128px;height: 44px;float:left;margin-left: 0px; display: block;background:url(<?php echo $_smarty_tpl->tpl_vars['t_dir']->value;?>
index/images/menulibg.gif) repeat-x}
.menulist .bd li a:hover{text-decoration: none;color: #f37c41}
.menulist .bd li a em,.menulist .bd li a .count,.menulist li.cur a{font-size:0px;background-image:url(<?php echo $_smarty_tpl->tpl_vars['t_dir']->value;?>
index/images/menu_pic2.gif);}
...
.userlist li .loading{width: 55px;height: 22px;background:url(<?php echo $_smarty_tpl->tpl_vars['t_dir']->value;?>
index/images/loading_s.gif);cursor: default;}
...
.userbox .loading{width: 80px;height: 30px;background:url(<?php echo $_smarty_tpl->tpl_vars['t_dir']->value;?>
index/images/loading_b.gif);cursor: default;}
...
.loginBg{width:100%;position:absolute;top:0;left:0;z-index:8888;display:none;background:url(http://mat1.gtimg.com/www/<?php echo $_smarty_tpl->tpl_vars['t_dir']->value;?>
index/images/qq2012/alphabg.png); _background:#000;_opacity:0.3_;filter:alpha(opacity=30);}
*html{
...
/*style 6.24 */
	...
	#commentArea .tips{float:left;margin-top:14px;margin-left:250px}
	 ...
	 #top_reply .globalNav{margin:35px 0 20px;padding:0 5px 0 10px;padding-bottom:0px;height:41px;line-height:41px;background: url(http://mat1.gtimg.com/caixin/<?php echo $_smarty_tpl->tpl_vars['t_dir']->value;?>
index/images/bg_maintit.png) repeat-x}
...
.shareBtn16 .s_qq { background:url(<?php echo $_smarty_tpl->tpl_vars['t_dir']->value;?>
index/images/qqshare_16_24.png) 0 5px no-repeat }
...
.shareBtn24 .s_qq { background:url(<?php echo $_smarty_tpl->tpl_vars['t_dir']->value;?>
index/images/qqshare_16_24.png) -18px -25px no-repeat }

/* sprite */
.shareBtn-bd a{ background:url(<?php echo $_smarty_tpl->tpl_vars['t_dir']->value;?>
index/images/s_gallery_2012110702.png) no-repeat 0 0; display:inline-block  }

/* 订阅更多媒体 */
.subMore{ position:absolute; top:15px; right:35px; font-size:14px; font-family:Microsoft Yahei; background:url(<?php echo $_smarty_tpl->tpl_vars['t_dir']->value;?>
index/images/sub_more.png) right 2px no-repeat; padding-right:18px;}
...
index/images/jquery.min.js"></script>
<script type="text/javascript">
    //标签切换
function change(x)
{
 for(h=0;h<2;h++){
 document.getElementById("ism"+h).className=' '
 document.getElementById("ism"+x).className=' cur'
 }
}
</script>
...
$(document).ready(function(){
  //$("#talklist").load("<?php echo $_smarty_tpl->tpl_vars['t_dir']->value;?>
index/home.html");
  $("#subscribeList").show();
  $("#mySubscribeList").hide();
...
<body id="home">
  <div class="headWrap" id="headWrap">
	<div class="header fY">
		<h1><a href="index.php" target="_self" bosszone="backhome1">订阅</a></h1>
		<ul style="display: none;" id="navBox" class="nav fY" bosszone="maiNav"><li><a href="http://dy.qq.com/">首页<i></i></a></li></ul>
      <a href="#" url="http://dy.qq.com/manage.htm#!/type/allMediaLibrary" node-type="manageNav" class="mBtn fr" bosszone="admin"></a>
   ...
   <div class="mainWrapTop" node-type="mainWrapTop">
   	<div class="mainWrap">
        ...
        <div class="wrapTab fY" node-type="wrapTab">
          <ul node-type="tabBox">
            <li class=" cur" onClick="change(0)" id="ism0" ><a href="#my">全部内容</a></li>
            <li class=" " onClick="change(1)" id="ism1" ><a href="#all">我的订阅</a></li>
          </ul>
    <!-- <div class="tool"><a href="/manage.htm#!/type/myMediaLibrary" action-type="islogin"></a></div> -->
        ...
        <div class="talklist" id="talklist">
            <!--全部内容start-->
          <ul class="ul1" id="subscribeList" style="">
            <li >
  <div class="avatar_s" bosszone="mediaPic">
    <a href="http://dy.qq.com/list-user.htm?chlid=1101" url="http://dy.qq.com/list-user.htm?chlid=1101" target="_blank"><img src="<?php echo $_smarty_tpl->tpl_vars['t_dir']->value;?>
index/images/0_006.jpeg"></a>
  </div>
  <div class="msgbox box-w box-radius box-shade">
   ...
   <div class="pt">
    <div class="inner" bosszone="mediaNews">
       <div class="pic">
        <a href="http://dy.qq.com/article.htm?id=20130812A000MJ00" target="_blank"><img src="<?php echo $_smarty_tpl->tpl_vars['t_dir']->value;?>
index/images/0_005.jpeg" <="" a="">
        ...
        </a><p><a href="http://dy.qq.com/article.htm?id=20130812A000MJ00" target="_blank"></a><a href="http://dy.qq.com/article.htm?id=20130812A000MJ00" target="_blank">这是最新的新闻</a></p>
        <div class="time">2013-08-10 22:32:25</div>
       </div>
    </div>
   </div>
  </div>
          ...
          <!--全部内容end-->
          <!--我的订阅start-->
          <ul class="ul1" id="mySubscribeList" style="display: none;">
<li >
  <div class="avatar_s" bosszone="mediaPic">
    <a href="http://dy.qq.com/list-user.htm?chlid=1101" url="http://dy.qq.com/list-user.htm?chlid=1101" target="_blank"><img src="<?php echo $_smarty_tpl->tpl_vars['t_dir']->value;?>
index/images/0_006.jpeg"></a>
...
<div class="rec-user clear">
  <div class="pic"><a href="http://dy.qq.com/list-user.htm?chlid=58" target="_blank" class="avatar_s" bosszone="subRE"><img src="<?php echo $_smarty_tpl->tpl_vars['t_dir']->value;?>
index/images/0_004.png" height="55" width="55"></a><a href="#" class="qx_b" action-data="chlid=58" istxt="1" action-type="unSubscribe" bosszone="subBtn2">取消</a></div>
  <div class="txt">
...
<div class="rec-user clear">
  <div class="pic"><a href="http://dy.qq.com/list-user.htm?chlid=1035" target="_blank" class="avatar_s" bosszone="subRE"><img src="<?php echo $_smarty_tpl->tpl_vars['t_dir']->value;?>
index/images/0_011.jpeg" height="55" width="55"></a><a href="#" class="dy_b" istxt="1" action-data="chlid=1035" action-type="subscribe" bosszone="subBtn2">订阅</a></div>
  <div class="txt">
...
<div class="rec-user clear">
  <div class="pic"><a href="http://dy.qq.com/list-user.htm?chlid=32" target="_blank" class="avatar_s" bosszone="subRE"><img src="<?php echo $_smarty_tpl->tpl_vars['t_dir']->value;?>
index/images/0.png" height="55" width="55"></a><a href="#" class="qx_b" action-data="chlid=32" istxt="1" action-type="unSubscribe" bosszone="subBtn2">取消</a></div>
  <div class="txt">

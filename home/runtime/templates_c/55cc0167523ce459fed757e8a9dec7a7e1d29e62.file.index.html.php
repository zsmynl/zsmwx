<?php /* Smarty version Smarty-3.1.14, created on 2013-08-23 12:24:54
         compiled from "F:\Apmserv\APMServ5\apm\APMServ5.2.6\www\htdocs\home\view\member\index.html" */ ?>
<?php /*%%SmartyHeaderCode:73425210eb364d3363-02227158%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '55cc0167523ce459fed757e8a9dec7a7e1d29e62' => 
    array (
      0 => 'F:\\Apmserv\\APMServ5\\apm\\APMServ5.2.6\\www\\htdocs\\home\\view\\member\\index.html',
      1 => 1377258390,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '73425210eb364d3363-02227158',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.14',
  'unifunc' => 'content_5210eb3669d363_32775895',
  'variables' => 
  array (
    't_dir' => 0,
    'login' => 0,
...
<?php if ($_valid && !is_callable('content_5210eb3669d363_32775895')) {function content_5210eb3669d363_32775895($_smarty_tpl) {?><!DOCTYPE html>
<html><head>
...
member/images/ico_pic2.gif); background-repeat:no-repeat; }
/*订阅 分享 箭头按钮*/
...
member/images/icon_3.png) no-repeat -240px -134px;cursor: pointer;}
...
member/images/loadgray.gif) no-repeat top;}
...
member/images/cked.png) no-repeat}
...
member/images/tabbg1.png) repeat-x bottom;}
...
member/images/tabbg2.png) repeat-x bottom;z-index: 99}
...
member/images/loading_s.gif);cursor: default;}
...
member/images/menulibg.gif);overflow: hidden;*zoom:1;}
...
member/images/menulibg.gif) repeat-x}
...
member/images/loading_b.gif);cursor: default;}
...
member/images/qq2012/alphabg.png); _background:#000;_opacity:0.3_;filter:alpha(opacity=30);}
*html{
...
member/images/bg_maintit.png) repeat-x}
...
member/images/qqshare_16_24.png) 0 5px no-repeat }
...
member/images/qqshare_16_24.png) -18px -25px no-repeat }

/* sprite */
.shareBtn-bd a{ background:url(<?php echo $_smarty_tpl->tpl_vars['t_dir']->value;?>
member/images/s_gallery_2012110702.png) no-repeat 0 0; display:inline-block  }
...
member/images/sub_more.png) right 2px no-repeat; padding-right:18px;}
...
$(document).ready(function(){
   /*   
   $.post("/index.php?controller=member&action=home",function(data){
    $("#talklist").html(data)
    },"html");
  ...
  $("#ism1").click(function(){
   $.post("/index.php?controller=member&action=talklist",function(data){
    $("#talklist").html(data)
    },"html");
  });
});
  ...
  <div class="headWrap" id="headWrap">
	<div class="header fY">
      ...
      <?php echo $_smarty_tpl->tpl_vars['login']->value;?>
        ...
        <!--
      <span class="loginwrap" id="loginStatus">你好，<?php echo $_smarty_tpl->tpl_vars['user']->value['name'];?>
，<a href="/index.php?controller=member&action=index" >个人中心</a> <a href="/index.php?controller=member&action=loginout">退出</a></span>
	-->
      </div>
</div>
   ...
   <div class="mainWrapTop" node-type="mainWrapTop">
   	<div class="mainWrap">
        ...
        <div class="wrapTab fY" node-type="wrapTab">
          <ul node-type="tabBox">
            <li class=" cur" onClick="change(0)" id="ism0" ><a href="javascript:void(0);">个人信息</a></li>
            <!--
            <li class=" " onClick="change(1)" id="ism1" ><a href="javascript:void(0);">文章列表</a></li>
            -->
          </ul>
    <!-- <div class="tool"><a href="/manage.htm#!/type/myMediaLibrary" action-type="islogin"></a></div> -->
        ...
        <div class="talklist" id="talklist">
          <ul class="ul1" node-type="subscribeList">用户名：<?php echo $_smarty_tpl->tpl_vars['user']->value['name'];?>
</ul>
...
member/images/0_011.jpeg" height="55" width="55"></a><a href="#" class="dy_b" istxt="1" action-data="chlid=1035" action-type="subscribe" bosszone="subBtn2">订阅</a></div>
  <div class="txt">
